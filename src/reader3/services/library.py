...
class ChapterContent:
    ...
    text: str         # Plain text for search context
...
def extract_plain_text(soup: BeautifulSoup) -> str:
    """Extract clean text for search usage."""
...
class DocumentService:
    ...
    def ingest(
        ...
        *,
        ...
        if suffix == ".epub":
            return process_epub(source_path, output_dir)
        raise ValueError("Only .epub and .pdf files are supported")

    def save(self, book: Book, output_dir: str) -> None:
    ...
    def chapter_texts(
        ...
        by_href = {chapter.href: chapter for chapter in book.spine}
        return [
            {
                "href": href,
                "title": by_href[href].title,
                "text": by_href[href].text,
            }
