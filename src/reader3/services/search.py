...
class SearchService:
    """Service boundary for chunking, indexing, and retrieval."""

    def __init__(self, books_dir: str, load_book_fn):
        self.books_dir = books_dir
        self.load_book = load_book_fn
        ...
        *,
        ...
        if mode == "semantic":
            return semantic_search_books(
                ...
                load_book_fn=self.load_book,
                limit=limit,
            )
        return self._exact_search(query, book_ids, limit)
    ...
    def _exact_search(
        ...
        for book_id in book_ids:
            ...
            for idx, chapter in enumerate(book.spine):
                ...
                text_lower = text.lower()
                start = 0
                while query_lower in text_lower[start:]:
