...
class TestMaxUploadSize:
    ...
    def test_default_max_upload_1024mb(self):
        """Test default max upload size is 1024 MB."""
        with patch.dict(os.environ, {}, clear=False):
            ...
            # Default should be 1024 MB
            assert server_module.MAX_UPLOAD_MB == 1024
            assert server_module.MAX_UPLOAD_BYTES == 1024 * 1024 * 1024
